...
public class GalleryViewModel: ObservableObject {
    ...
    public var onEdit: (BoredDevViewModel) -> Void = { _ in }

    
    public init(collection: IdentifiedArrayOf<BoredDevViewModel> = []) {
    ...
    public func addBoredDev(boredDev: BoredDev) {
